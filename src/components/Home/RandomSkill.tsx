        ...
        <div className="text-center mb-16">
          ...
          <div className="relative inline-block">
            <Button 
              ...
              className="group relative bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-bold py-5 px-10 rounded-2xl text-lg transition-all duration-500 hover:scale-105 shadow-2xl hover:shadow-purple-500/25 border-0 overflow-hidden cursor-pointer"
            >
