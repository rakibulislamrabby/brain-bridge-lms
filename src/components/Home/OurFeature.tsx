...
export default function OurFeature() {
  return (
    <section className="py-12 sm:py-16 lg:py-20 bg-gray-900 pb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <span className="text-xl sm:text-2xl">🌐</span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">Our Features</h2>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <Card key={index} className="p-4 sm:p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:bg-gray-800 bg-gray-800 hover:border-purple-500 cursor-pointer border border-gray-700 hover:shadow-purple-500/20">
                <CardContent className="space-y-3 sm:space-y-4">
                  <div className="text-purple-400 transition-transform duration-300 hover:scale-110">{feature.icon}</div>
                  <h3 className="font-semibold text-base sm:text-lg transition-colors duration-300 hover:text-purple-400 text-white">{feature.title}</h3>
